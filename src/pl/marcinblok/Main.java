...
class Main {
	public static void main(String args[]) {
		...
		/*
		 * System.out.println(min(1, 2, 3)); System.out.println(min(-1, -2, -3));
		 * System.out.println(min(3, 5, 3)); System.out.println(min(5, 5, 10));
		 */
...
// 4. Kt�re oceny przewa�aj� ?
		...
		System.out.println("Najcz�ciej wyst�puj�c� ocen� jest " + (indexNajwiekszej + 1));

	}
}

/*
 * Napisz funkcj�, kt�ra wybiera najmniejsz� z trzech liczb.
 * 
 * 
 * //
 * 
 ...
 * zmienia si� tr�jk�t !!! } System.out.println(); }
 * 
 * System.out.println();
 * 
 ...
 * 
 * 
 * Wskaz�wka: Musisz napisa� cia�o istniej�cej funkcji min. Wymagania:
 * 
 ...
 * times. The main method should display the result of the min method. Each
 * time, on a new line. The min method must return the minimum of the numbers a,
 * b, and c.
 * 
 * 
 * 
 ...
 * int m2;
 * 
 * if ((a < b) && (a < c)){ m2 = a; }else if ((b < a) && (b < c)){ m2 = b; }else
 * if ((c < a) && (c < b)){ m2 = c; }
 * 
 * return m2; }
 * 
